...
pvi_sharedarrays = ParallelValueIterationSolver(max_iterations=15, belres=0., verbose=true, n_procs=N_PROCS)
...
pvi_sync = ParallelSynchronousValueIterationSolver(max_iterations=15, belres=0., verbose=true, n_procs=N_PROCS)
println("Starting parallel synchronous vi")
@time solve(pvi_sync, dpomdp)


# vi = ValueIterationSolver(max_iterations=15, belres=0., verbose=true)
